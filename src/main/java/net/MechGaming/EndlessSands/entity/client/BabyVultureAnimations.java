...
public final class BabyVultureAnimations {
    public static final AnimationDefinition WALKING = AnimationDefinition.Builder.withLength(0.5F).looping()
            ...
            .addAnimation("Legs", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.25F, KeyframeAnimations.posVec(0.0F, 0.0937F, -0.4226F), AnimationChannel.Interpolations.LINEAR),
